...
def karek(y):
    s = len(giris.get())
    giris.insert(s, str(y))


pencere = Tk()
pencere.geometry("300x300")

giris = Entry(font="Verdana 14 bold", width=17, justify=RIGHT)
...
sil.place(x=220, y=50)

kare = Button(text="^2", font="Verdana 14 bold", command=lambda x="^2": karek())
kare.place(x=220, y=60)
